...
inaSpeechSegmenter was ranked #1 against 6 open-source VAD system on a French TV and radio benchmark : LIUM_SpkDiarization, Pyannote, Rvad, Silero, Speechbrain
```bibtex
